...
public class compounder extends AppCompatActivity {

    ImageView profile_image_compounder, ask_for_help;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compounder);
        ...
        profile_image_compounder = findViewById(R.id.profile_image_compounder);
        ask_for_help = findViewById(R.id.ask_for_help);

        orra = new open_request_recycleview_adapter(compounder.this,arr);
        recycleview_donor_patient.setAdapter(orra);




        profile_image_compounder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(compounder.this,all_profile.class);
                intent.putExtra("user_type","compounder");
                finish();
        ...
        ask_for_help.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(compounder.this,raise_request2.class);
                intent.putExtra("user_type","compounder");
                finish();
                startActivity(intent);
            }
