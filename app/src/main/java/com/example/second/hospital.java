...
public class hospital extends AppCompatActivity {
    ...
    ImageView profile_image_hospital, ask_for_help;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_image_hospital = findViewById(R.id.profile_image_hospital);
        ask_for_help = findViewById(R.id.ask_for_help);

        orra = new open_request_recycleview_adapter(hospital.this,arr);
        recycleview_donor_patient.setAdapter(orra);




        profile_image_hospital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(hospital.this,all_profile.class);
                intent.putExtra("user_type","hospital");
                finish();
        ...
        ask_for_help.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(hospital.this,raise_request2.class);
                intent.putExtra("user_type","hospital");
                finish();
                startActivity(intent);
            }
