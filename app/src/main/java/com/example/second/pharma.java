...
public class pharma extends AppCompatActivity {
    ...
    ImageView profile_image_pharma, ask_for_help;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_image_pharma = findViewById(R.id.profile_image_pharma);
        ask_for_help = findViewById(R.id.ask_for_help);

        orra = new open_request_recycleview_adapter(pharma.this,arr);
        recycleview_donor_patient.setAdapter(orra);




        profile_image_pharma.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(pharma.this,all_profile.class);
                intent.putExtra("user_type","pharma");
                finish();
        ...
        ask_for_help.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(pharma.this,raise_request2.class);
                intent.putExtra("user_type","pharma");
                finish();
                startActivity(intent);
            }
